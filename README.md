...
Every items has the keys *Typ*, *Name* and *Name_sci*, all other keys are optional.
So far, *Name* is used for matching.
...
**Also check the [description](https://github.com/digital-codes/auenBot/blob/main/description.md)**
